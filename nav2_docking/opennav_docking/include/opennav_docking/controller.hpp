...
public:
  ...
  /**
   * @brief Limit the command velocity using acceleration constraints.
   * @param cmd Desired command velocity.
   * @param previous_cmd Previous open-loop command velocity.
   * @param dt Control loop duration [s].
   * @returns Acceleration limited command velocity.
   */
  geometry_msgs::msg::Twist limitVelocityCommand(
...
protected:
  ...
  double max_linear_accel_, max_linear_decel_, max_angular_accel_;
