  ...
  const std::shared_ptr<nav2_costmap_2d::Costmap2DROS>/*costmap_ros*/)
{
  ...
  nav2_util::declare_parameter_if_not_declared(
    node,
    plugin_name + ".fine_xy_goal_tolerance", rclcpp::ParameterValue(0.10));
  nav2_util::declare_parameter_if_not_declared(
    node,
    plugin_name + ".coarse_xy_goal_tolerance", rclcpp::ParameterValue(0.25));
  nav2_util::declare_parameter_if_not_declared(
    node,
  ...
  nav2_util::declare_parameter_if_not_declared(
    node,
    plugin_name + ".trans_stopped_velocity", rclcpp::ParameterValue(0.10));
  nav2_util::declare_parameter_if_not_declared(
    node,
    plugin_name + ".rot_stopped_velocity", rclcpp::ParameterValue(0.10));
  nav2_util::declare_parameter_if_not_declared(
    node,
    plugin_name + ".required_stagnation_cycles", rclcpp::ParameterValue(15));

  node->get_parameter(plugin_name + ".fine_xy_goal_tolerance", fine_xy_goal_tolerance_);
  node->get_parameter(plugin_name + ".coarse_xy_goal_tolerance", coarse_xy_goal_tolerance_);
  ...
  node->get_parameter(plugin_name + ".required_stagnation_cycles", required_stagnation_cycles_);
