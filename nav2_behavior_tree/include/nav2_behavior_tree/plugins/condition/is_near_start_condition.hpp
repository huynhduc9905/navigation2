 ...
 */
class IsNearStartCondition : public BT::ConditionNode
{
public:
  /**
   ...
   */
  IsNearStartCondition(
    const std::string & condition_name,
    const BT::NodeConfiguration & conf);

  IsNearStartCondition() = delete;

  /**
   * @brief A destructor for nav2_behavior_tree::GoalReachedCondition
   */
  ~IsNearStartCondition() override;
...
#endif  // NAV2_BEHAVIOR_TREE__PLUGINS__CONDITION__IS_NEAR_START_CONDITION_HPP_
